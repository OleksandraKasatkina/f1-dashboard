...
DRIVERS_2026 = [
    ...
    {'name': 'Max Verstappen',    'code': 'VER', 'number': 33, 'team': 'Red Bull Racing', 'nationality': '🇳🇱 Dutch',       'dob': '30 Sep 1997', 'championships': 4, 'wiki': 'Max_Verstappen',                  'accent': '#EA6B00', 'quote': 'Simply lovely!', 'bio': 'Four-time world champion. Leading Red Bull into the new Ford powertrain era.'},
